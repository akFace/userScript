...
// @supportURL   https://update.greasyfork.org/scripts/508672
// @match        *://*.douyin.com/*
// @match        *://*.iesdouyin.com/*
...
// @namespace    https://update.greasyfork.org/scripts/508672
...
(() => {
  ...
  const switchMaxResolution = () => {
    ...
    const resolutionOptions = Array.from(
      document.querySelectorAll("div.virtual > div.item")
    ).filter(
      (el) =>
        el.textContent &&
